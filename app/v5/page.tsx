...
/**
 * puenpublishing.com/v5 — printed inside the colouring book, so this address is
 * fixed forever. What plays here is the "v5" row in public.videos, which means a
...
export const metadata: Metadata = {
  title: "Video 5 — The Geezy Goober Explorer Fleet",
  // A print destination, not a page anyone should reach from a search result.
  robots: { index: false, follow: true },
};

export default function Video5Page() {
  return <VideoPage slug="v5" />;
}
