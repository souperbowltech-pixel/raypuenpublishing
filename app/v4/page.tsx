...
/**
 * puenpublishing.com/v4 — printed inside the colouring book, so this address is
 * fixed forever. What plays here is the "v4" row in public.videos, which means a
